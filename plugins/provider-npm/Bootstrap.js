console.log("Warning: you used npm as a provider meaning GuPM is going to use package.json instead of gupm.json which is not recommmanded.")
...
saveJsonFile("package.json", result)